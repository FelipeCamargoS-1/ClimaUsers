...
export function Login() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,#e3e9ff_0,#f5f7fc_42%,#eef3fb_100%)] px-6 py-10 text-[#1b2233] dark:bg-[radial-gradient(circle_at_top_left,#1e2440_0,#0f1424_42%,#0b101b_100%)] dark:text-white">
